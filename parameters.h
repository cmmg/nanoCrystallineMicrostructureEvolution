...
#define InterfaceEnergyParameter 4.0e-1//2*8.0e-1// {1.0e-2, 1.0e-2, 1.0e-2} //{Kx, Ky, Kz}
...
#define M_alpha  1//1.0e-4//1.0e-2//1.0e-4//1.0e-4 //0.001

//time step controls
#define TimeStep 5.0e-7
#define TotalTime 7500*TimeStep
